 ...
 */
class CardOnlyContentBlockService extends AbstractBlockService implements BlockServiceInterface
{
    protected $template = 'blocks/card_only_content_block.html.twig';
    protected $dm;
