 ...
 */
class CardTextWithoutFooterBlockService extends AbstractBlockService implements BlockServiceInterface
{
    protected $template = 'blocks/card_text_without_footer_block.html.twig';
    protected $dm;
